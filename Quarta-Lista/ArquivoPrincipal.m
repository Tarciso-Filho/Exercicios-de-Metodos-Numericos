...
tamA_1a = 1:size(difA_1a,2)
tamB_1a = 1:size(difB_1a,2)
...
tamA_1b = 1:size(difA_1b,2)
tamB_1b = 1:size(difB_1b,2)
...
tamA_1c = 1:size(difA_1c,2)
tamB_1c = 1:size(difB_1c,2)
plot( tamA_1c, difA_1c )
plot( tamB_1c, difB_1c )

A_1d = [4 1 1 0 1;-1 -3 1 1 0;2 1 5 -1 -1;-1 -1 -1 4 0;0 2 -1 1 4]
b_1d = [6 6 6 6 6]
...
tamA_1d = 1:size(difA_1d,2)
tamB_1d = 1:size(difB_1d,2)
...
tamA_2a = 1:size(difA_2a,2)
tamB_2a = 1:size(difB_2a,2)
...
tamA_2b = 1:size(difA_2b,2)
tamB_2b = 1:size(difB_2b,2)
...
tamA_2c = 1:size(difA_2c,2)
tamB_2c = 1:size(difB_2c,2)
plot( tamA_2c, difA_2c )
plot( tamB_2c, difB_2c )

A_2d = [4 -1 0 -1 0 0;-1 4 -1 0 -1 0;0 -1 4 0 0 -1;-1 0 0 4 -1 0;0 -1 0 -1 4 -1;0 0 -1 0 -1 4]
b_2d = [0 5 0 6 -2 6]
...
tamA_2d = 1:size(difA_2d,2)
tamB_2d = 1:size(difB_2d,2)
